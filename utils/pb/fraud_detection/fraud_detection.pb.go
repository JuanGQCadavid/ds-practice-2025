...
var file_fraud_detection_fraud_detection_proto_rawDesc = string([]byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xc5, 0x01, 0x0a, 0x15, 0x46, 0x72, 0x61, 0x75, 0x64, 0x44, 0x65, 0x74,
	...
	0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x44, 0x5a, 0x42, 0x67,
...
var file_fraud_detection_fraud_detection_proto_depIdxs = []int32{
	...
	2, // 3: fraud.FraudDetectionService.initOrder:output_type -> common.InitResponse
	3, // 4: fraud.FraudDetectionService.checkUser:output_type -> common.NextResponse
	3, // 5: fraud.FraudDetectionService.checkCreditCard:output_type -> common.NextResponse
