...
class TransactionVerificationRequestInit(_message.Message):
...
class TransactionVerificationRequestClock(_message.Message):
...
class TransactionVerificationResponseClock(_message.Message):
    __slots__ = ("response", "clock")
    RESPONSE_FIELD_NUMBER: _ClassVar[int]
    CLOCK_FIELD_NUMBER: _ClassVar[int]
    response: TransactionVerificationResponse
    clock: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, response: _Optional[_Union[TransactionVerificationResponse, _Mapping]] = ..., clock: _Optional[_Iterable[int]] = ...) -> None: ...
