...
class TransactionVerificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.checkTransaction = channel.unary_unary(
                '/transaction.TransactionVerificationService/checkTransaction',
...
class TransactionVerificationService(object):
    ...
    def checkTransaction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/transaction.TransactionVerificationService/checkTransaction',
